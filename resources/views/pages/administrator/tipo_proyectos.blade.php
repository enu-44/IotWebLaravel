...
<div class="card">
    ...
    <div class="card-body" style="padding:30px;">
        ...
        <table width="100%" id="table_tipoproyectos" class="table table-striped table-bordered nowrap" >
                <thead>
                    <tr>
                         <th>Id</th>
                         <th>Nombre</th>
                 ...
                 <tbody>
                    ...
                    <tr>
                       ...
                       <td>{{$item->description_tipo_proyecto}}</td>
                       <td>
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                <form class="mb-2" role="form"  method="POST" action="{{ url('/deletetipoproyectos') }}"> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tipo Proyectos</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form  role="form" method="POST" action="{{ url('/tipoproyectos') }}">
...
<script type="text/javascript">
    $(document).ready(function($){
      ...
      $(".li_tipoproyectos").addClass('active');


        //  $('#dgdfg').click();
        var Table = $('#table_tipoproyectos').DataTable({
          'bFilter': true,
          'bInfo': true,
          'responsive': true,
          "bAutoWidth": true,
